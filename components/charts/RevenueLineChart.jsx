  ...
  return (
    <div className="w-full bg-white rounded-2xl sm:rounded-3xl border border-slate-100 shadow-sm p-4 sm:p-6">
      <div className="mb-4 sm:mb-6">
        <h2 className="text-lg sm:text-xl font-bold text-slate-800 break-words">{title}</h2>
        <p className="text-xs sm:text-sm text-slate-500 break-words">{subtitle}</p>
      </div>

      {/* Responsive Fix: Scaled down height for smaller screens, full height for desktop */}
