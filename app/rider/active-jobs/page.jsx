...
import { Loader2, Navigation, MapPin, Store, Search, ChevronLeft, ChevronRight, RefreshCcw } from "lucide-react";
...
export default function RiderActiveJobsPage() {
  ...
  if (loading && jobs.length === 0) return <div className="min-h-[100dvh] flex items-center justify-center bg-slate-50"><Loader2 className="animate-spin text-blue-600 w-10 h-10" /></div>;
